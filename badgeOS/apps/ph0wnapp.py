...
class App:
    def __init__(self, badge):
        self.badge = badge
        self.NAME = "Ph0wn"
        self.headers={'Cookie': 'session=d8d74547-ba29-42fb-85cf-6d144f0e648e.9OxdfrUG-o2FHkWE0AWKWqRLtp4'}
    ...
    def check_first_blood(self):
        if self.badge.net.online():
            response = urequests.get('https://demo.ctfd.io/api/v1/challenges', headers=self.headers)
    ...
    def show_scoreboard(self):
        if self.badge.net.online():
            ...
            response = urequests.get('https://demo.ctfd.io/api/v1/scoreboard/top/5')
            try:
                data = response.json()
            except ValueError:
